...
const Agent = ({ userName, userId, type, interviewId, questions }: AgentProps) => {
    ...
    cosnt handleGenerateFeedback = async (messages: SavedMessage[]) => {
        console.log('Generating Feedback in here.');


        //TODO: I have to create a server action that generates feedbacks
        const { success, id } = {
            success: true,
            id: 'feedback-id '
        }
            ...
            <div className='call-view'>
                ...
                <div className='card-border'>
                    <div className='card-content'>
                        <Image src='/abe.jpeg' alt='User Avatar' width={540} height={540} className='rounded-full object-cover size-[120px]' />
                        <h3>{userName}</h3>
                    </div>
                </div>
            </div>
